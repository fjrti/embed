...
//  Commanffucntion ( 0x38 ) ; // in case of 8 bit mode

    // changes for 4bit mode :
...
// Checking row 1 :
    ...
    if ( ((Keypad_Out&(1<<Row1))==0) ) {
        ...
        if 	   ( ((buffer&(1<<Col1))==0) )      LCD_print ( "1") ;
        else if ( ( buffer & (1<<Col2) ) == 0 ) LCD_print ( "2") ;
        else if ( ( buffer & (1<<Col3) ) == 0 ) LCD_print ( "3") ;
...
// Checking row 3 :
    ...
    if ( ((Keypad_Out&(1<<Row3))==0) ) {
        ...
        if 		 ( ( buffer & (1<<Col1) ) == 0 ) LCD_print ( "7") ;
        else if  ( ( buffer & (1<<Col2) ) == 0 ) LCD_print ( "8") ;
        else if  ( ( buffer & (1<<Col3) ) == 0 ) LCD_print ( "9") ;
...
// Checking row 4 :
    ...
    if ( ((Keypad_Out&(1<<Row4))==0) ) {
        ...
        if 		 ( ( buffer & (1<<Col1) ) == 0 ) LCD_print ( "*" ) ;
        else if  ( ( buffer & (1<<Col2) ) == 0 ) LCD_print ( "0") ;
        else if  ( ( buffer & (1<<Col3) ) == 0 ) LCD_print ( "#") ;
