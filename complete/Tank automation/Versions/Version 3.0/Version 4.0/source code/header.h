...
BUGS INFO :
    ...
    turning motors off at >1/4 level
    full line-checking support added
    exclusion of wastefull functions present in previous release
    artificial error conditions
    bitwise operators instead of || in functions
    loadOff is still done by macro
